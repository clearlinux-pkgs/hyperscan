...
Source0  : https://github.com/intel/hyperscan/archive/v5.1.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1565334834
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/haswell/avx512_1/libhs.so.5.1.1
/usr/lib64/haswell/libhs.so.5
/usr/lib64/haswell/libhs.so.5.1.1
/usr/lib64/haswell/libhs_runtime.so.5
/usr/lib64/haswell/libhs_runtime.so.5.1.1
/usr/lib64/libhs.so.5
/usr/lib64/libhs.so.5.1.1
/usr/lib64/libhs_runtime.so.5
/usr/lib64/libhs_runtime.so.5.1.1
