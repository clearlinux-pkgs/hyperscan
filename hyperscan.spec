...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1572795114
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/hyperscan-5.2.1/COPYING %{buildroot}/usr/share/package-licenses/hyperscan/460136879250bc39dbc8be7799af9c079527808f
cp %{_builddir}/hyperscan-5.2.1/LICENSE %{buildroot}/usr/share/package-licenses/hyperscan/e9e53a0b2358d3fd707a717d971d01ef87bffd0e
pushd clr-build-avx512
%make_install_avx512  || :
popd
pushd clr-build-avx2
...
/usr/lib64/haswell/avx512_1/libhs.so.5.2.1
/usr/lib64/haswell/libhs.so.5
/usr/lib64/haswell/libhs.so.5.2.1
/usr/lib64/haswell/libhs_runtime.so.5
/usr/lib64/haswell/libhs_runtime.so.5.2.1
/usr/lib64/libhs.so.5
/usr/lib64/libhs.so.5.2.1
/usr/lib64/libhs_runtime.so.5
/usr/lib64/libhs_runtime.so.5.2.1
